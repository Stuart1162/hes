        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div>
                ...
                <div className="space-y-6">
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">123 Electric Avenue</p>
                      <p className="text-gray-600">London, SE1 1AA</p>
                      <p className="mt-2">
                        <a 
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">+44 1234 567890</p>
                  ...
                  <div className="flex">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="mt-1 text-gray-600">info@hendersonelectrical.co.uk</p>
            ...
            <div className="mt-6 bg-white rounded-lg shadow-lg overflow-hidden">
              <div className="p-6">
                <h3 className="text-lg font-medium text-gray-900 mb-4">Emergency Call-Out</h3>
                <p className="text-gray-600 mb-4">
                  For emergency electrical issues outside of normal business hours, please call our 24/7 emergency line:
                </p>
                <a 
                  href="tel:+441234567890" 
                  className="inline-flex items-center justify-center w-full px-6 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-600 hover:bg-red-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 transition-colors duration-200"
                >
                ...
                <p className="mt-3 text-sm text-gray-500">
                  Additional charges may apply for emergency call-outs.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="rounded-lg overflow-hidden shadow-xl">
            <iframe 
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2483.674144225871!2d-0.12775868423071924!3d51.50329727963415!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487604c38c8cd1d9%3A0xb78f2474b9a45aa9!2sBig%20Ben!5e0!3m2!1sen!2suk!4v1620000000000!5m2!1sen!2suk" 
              width="100%" 
              height="450" 
              style={{ border: 0 }} 
              allowFullScreen="" 
